...
const COVERAGE: &[(i16, &str, &str)] = &[
    ...
    (
        9,
        "OffsetFetch",
        "contract_offset_fetch_unknown_group_returns_minus_one",
    ),
    (
        10,
        "FindCoordinator",
        "contract_find_coordinator_returns_self",
    ),
    ...
    (
        15,
        "DescribeGroups",
        "contract_describe_groups_active_member",
    ),
    (
        16,
        "ListGroups",
        "contract_list_groups_returns_joined_group",
    ),
    (
        18,
        "ApiVersions",
    ...
    (
        22,
        "InitProducerId",
        "contract_init_producer_id_returns_valid_id",
    ),
    (
        23,
        "OffsetForLeaderEpoch",
        "contract_offset_for_leader_epoch_returns_hwm",
    ),
    (
        24,
        "AddPartitionsToTxn",
        "contract_add_partitions_to_txn_basic",
    ),
    ...
    (
        32,
        "DescribeConfigs",
        "contract_describe_configs_returns_topic_configs",
    ),
    (33, "AlterConfigs", "contract_alter_configs_no_op_success"),
    (
        35,
        "DescribeLogDirs",
        "contract_describe_log_dirs_returns_memory_dir",
    ),
    (
        37,
        "CreatePartitions",
        "contract_create_partitions_increases_count",
    ),
    (42, "DeleteGroups", "contract_delete_groups_removes_group"),
    (
        43,
        "ElectLeaders",
        "contract_elect_leaders_succeeds_on_single_node",
    ),
    (
        44,
        "IncrementalAlterConfigs",
        "contract_incremental_alter_configs_succeeds",
    ),
    (
        47,
        "OffsetDelete",
        "contract_offset_delete_clears_committed_offset",
    ),
    (
        60,
        "DescribeCluster",
        "contract_describe_cluster_returns_broker",
    ),
    (
        66,
        "ListTransactions",
        "contract_list_transactions_returns_empty",
    ),
    (
        75,
        "DescribeTopicPartitions",
        "contract_describe_topic_partitions_returns_partition_leader",
    ),
];
